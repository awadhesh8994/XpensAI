...
export default function UserHome() {
    const {dashboardData, setDashboardData, loadingDashboardData, setLoadingDashboardData} = useAuthContext();
    ...
    return (<div className="px-4  md:px-6 lg:px-8 max-w-7xl mx-auto">
            {/* Hero header */}
            <div
                className="mt-2 mb-6 rounded-2xl bg-gradient-to-r from-indigo-500/10 via-blue-500/10 to-emerald-500/10 border border-indigo-100/60 p-5">
                <div className="flex items-center justify-between">
                    ...
                    >
                        {isUp ? <ArrowUpRight className="w-3.5 h-3.5 mr-1"/> :
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <StatCard
                    ...
                    trendIcon={isUp ? (<ArrowUpRight className="w-4 h-4 text-emerald-600"/>) : (
                ...
                <StatCard
                    ...
                    value={`${data.topPaymentMethodUsed?.name ?? "-"} · ${formatCurrency(data.topPaymentMethodUsed?.amount ?? 0, currency)}`}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-4">
                ...
                >
                    <div>
                        <div
                            className={`inline-block text-xs px-2 py-1 rounded-md mb-3 ${getSeverityBadge(data.severity)}`}>
